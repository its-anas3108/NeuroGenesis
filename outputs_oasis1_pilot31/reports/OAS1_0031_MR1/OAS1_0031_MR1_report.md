...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0031_MR1` |
| Generated | 2026-09-21 23:26:22 |
...
- Top-class probability: 0.5157
- Margin over runner-up: 0.2171
- Normalised predictive entropy: 0.9240 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Insula | 0.9389 | Articulatory planning, phonological awareness |
| 2 | Wernicke | 0.5336 | Speech comprehension, auditory word recognition |
| 3 | Broca | 0.3009 | Speech production, phonological encoding |
| 4 | IFG | 0.1838 | Syntactic processing, verbal working memory |
| 5 | STG | 0.1387 | Auditory-verbal processing, spectrotemporal analysis |
...
|---|---|---|---|
| IFG -> Insula | 0.2070 | 0.8060 | Inferior_Fronto_Occipital_Fasciculus |
| Broca -> Insula | 0.2027 | 0.8074 | Short_Arcuate_Fibres |
| STG -> Insula | 0.1997 | 0.8060 | Extreme_Capsule_System |
| Wernicke -> Insula | 0.1904 | 0.8087 | Extreme_Capsule_System |
| IFG -> Broca | 0.1852 | 0.8034 | Within_IFG_Fibres |

### Highest propagation-representation pathways (NeuroProp-X ANP)

| Pathway | Propagation score |
|---|---|
| Insula -> Wernicke | 0.7038 |
| Wernicke -> Insula | 0.6952 |
| Insula -> Broca | 0.6725 |
| Broca -> Insula | 0.6695 |
| IFG -> Insula | 0.6543 |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.8281 |
| AD-associated propensity | 0.5248 |
...
|---|---|---|---|---|---|
| 1 | Insula | 1.0000 | 1.0000 | 1.0000 | 1.0000 |
| 2 | Wernicke | 0.3565 | 0.4934 | 0.0000 | 0.5303 |
| 3 | Broca | 0.3173 | 0.2027 | 0.7875 | 0.0000 |
| 4 | IFG | 0.2424 | 0.0563 | 0.5947 | 0.1381 |
| 5 | STG | 0.1797 | 0.0000 | 0.2120 | 0.3871 |
...
|---|---|---|---|
| Insula | entropy | 0.0521 | increases |
| Wernicke | surface_to_volume_ratio | 0.0471 | increases |
| Insula | surface_to_volume_ratio | 0.0396 | increases |
| STG | std_intensity | 0.0199 | increases |
| STG | surface_to_volume_ratio | 0.0173 | increases |
| IFG | std_intensity | 0.0152 | increases |
| Insula | kurtosis | 0.0056 | increases |
| Wernicke | atrophy_index | 0.0054 | increases |
| Broca | surface_to_volume_ratio | 0.0020 | increases |
| STG | normalized_volume | 0.0018 | increases |
