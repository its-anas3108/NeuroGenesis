...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0033_MR1` |
| Generated | 2026-09-21 23:26:25 |
...
- Top-class probability: 0.4516
- Margin over runner-up: 0.1267
- Normalised predictive entropy: 0.9641 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | IFG | 0.6922 | Syntactic processing, verbal working memory |
| 2 | Insula | 0.6601 | Articulatory planning, phonological awareness |
| 3 | Broca | 0.4831 | Speech production, phonological encoding |
| 4 | STG | 0.2979 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Wernicke | 0.2818 | Speech comprehension, auditory word recognition |
...
|---|---|---|---|
| IFG -> Broca | 0.2229 | 0.8103 | Within_IFG_Fibres |
| STG -> Broca | 0.2123 | 0.7949 | no prior edge |
| Wernicke -> Broca | 0.2110 | 0.8044 | Superior_Longitudinal_Fasciculus |
| Insula -> Broca | 0.2023 | 0.8094 | Short_Arcuate_Fibres |
| Broca -> IFG | 0.1893 | 0.8085 | Within_IFG_Fibres |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.7238 |
| AD-associated propensity | 0.4701 |
...
|---|---|---|---|---|---|
| 1 | Insula | 0.6688 | 0.9219 | 0.0000 | 1.0000 |
| 2 | IFG | 0.6018 | 1.0000 | 0.6725 | 0.0000 |
| 3 | Broca | 0.5523 | 0.4906 | 1.0000 | 0.1868 |
| 4 | Wernicke | 0.0492 | 0.0000 | 0.1082 | 0.0558 |
| 5 | STG | 0.0413 | 0.0392 | 0.0603 | 0.0251 |
...
|---|---|---|---|
| Insula | surface_to_volume_ratio | 0.0842 | increases |
| Insula | surface_area_vox | -0.0665 | decreases |
| Broca | brain_volume_mm3 | 0.0251 | increases |
| STG | mean_intensity | 0.0219 | increases |
| IFG | skewness | 0.0182 | increases |
| Wernicke | normalized_volume | 0.0132 | increases |
| Wernicke | surface_area_vox | 0.0132 | increases |
| Insula | gm_volume_mm3 | 0.0124 | increases |
| Broca | kurtosis | 0.0103 | increases |
| Broca | entropy | 0.0099 | increases |
