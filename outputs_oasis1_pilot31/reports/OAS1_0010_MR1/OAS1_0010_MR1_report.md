...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0010_MR1` |
| Generated | 2026-09-21 23:26:04 |
...
**Model-assigned stage: MCI** (Mild cognitive impairment / very mild dementia)
...
Reference CDR-derived stage for this session: **CN**. The model's assignment differs from it.

### Model confidence

- Top-class probability: 0.5197
- Margin over runner-up: 0.2357
- Normalised predictive entropy: 0.9259 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Wernicke | 0.9271 | Speech comprehension, auditory word recognition |
| 2 | Broca | 0.6692 | Speech production, phonological encoding |
| 3 | STG | 0.3917 | Auditory-verbal processing, spectrotemporal analysis |
| 4 | Insula | 0.3651 | Articulatory planning, phonological awareness |
| 5 | IFG | 0.3400 | Syntactic processing, verbal working memory |
...
|---|---|---|---|
| Wernicke -> Insula | 0.2118 | 0.8069 | Extreme_Capsule_System |
| Broca -> Insula | 0.2024 | 0.8053 | Short_Arcuate_Fibres |
| IFG -> Insula | 0.1976 | 0.8016 | Inferior_Fronto_Occipital_Fasciculus |
| STG -> Insula | 0.1896 | 0.8027 | Extreme_Capsule_System |
| Insula -> Broca | 0.1728 | 0.8082 | Short_Arcuate_Fibres |

### Highest propagation-representation pathways (NeuroProp-X ANP)

| Pathway | Propagation score |
|---|---|
| Broca -> Wernicke | 0.7195 |
| Wernicke -> Broca | 0.7159 |
| STG -> Wernicke | 0.6952 |
| Wernicke -> STG | 0.6799 |
| Insula -> Wernicke | 0.6764 |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.3446 |
| AD-associated propensity | 0.5223 |
| Stage-transition propensity | 0.7837 |
| Transition target | AD |

_Propensity of the current representation toward the AD-associated representation._
...
|---|---|---|---|---|---|
| 1 | Broca | 0.6657 | 0.5608 | 0.4712 | 1.0000 |
| 2 | Wernicke | 0.4692 | 1.0000 | 0.2256 | 0.0051 |
| 3 | Insula | 0.3712 | 0.0428 | 1.0000 | 0.1803 |
| 4 | STG | 0.1207 | 0.0881 | 0.2848 | 0.0000 |
| 5 | IFG | 0.0401 | 0.0000 | 0.0000 | 0.1338 |
...
|---|---|---|---|
| Insula | normalized_volume | 0.0436 | increases |
| IFG | normalized_volume | 0.0408 | increases |
| Broca | gm_fraction | 0.0342 | increases |
| Broca | normalized_volume | 0.0272 | increases |
| Wernicke | normalized_volume | 0.0204 | increases |
| STG | surface_to_volume_ratio | 0.0173 | increases |
| Broca | cortical_thickness_mm | 0.0160 | increases |
| STG | atrophy_index | 0.0156 | increases |
| Broca | mean_intensity | 0.0150 | increases |
| Wernicke | mean_intensity | 0.0128 | increases |
