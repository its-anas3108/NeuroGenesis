...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0019_MR1` |
| Generated | 2026-09-21 23:26:12 |
...
- Top-class probability: 0.5928
- Margin over runner-up: 0.3123
- Normalised predictive entropy: 0.8451 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | STG | 0.8350 | Auditory-verbal processing, spectrotemporal analysis |
| 2 | Broca | 0.6897 | Speech production, phonological encoding |
| 3 | IFG | 0.6538 | Syntactic processing, verbal working memory |
| 4 | Insula | 0.6319 | Articulatory planning, phonological awareness |
| 5 | Wernicke | 0.6049 | Speech comprehension, auditory word recognition |
...
|---|---|---|---|
| Wernicke -> Insula | 0.2035 | 0.8063 | Extreme_Capsule_System |
| Broca -> Insula | 0.2006 | 0.8082 | Short_Arcuate_Fibres |
| STG -> Insula | 0.1933 | 0.8101 | Extreme_Capsule_System |
| IFG -> Insula | 0.1928 | 0.8076 | Inferior_Fronto_Occipital_Fasciculus |
| STG -> Broca | 0.1617 | 0.8031 | no prior edge |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.5734 |
| AD-associated propensity | 0.5039 |
| Stage-transition propensity | 0.6468 |
...
|---|---|---|---|---|---|
| 1 | STG | 0.5299 | 1.0000 | 0.1584 | 0.2747 |
| 2 | Broca | 0.5131 | 0.3684 | 0.2189 | 1.0000 |
| 3 | IFG | 0.3473 | 0.2125 | 0.0000 | 0.8742 |
| 4 | Insula | 0.3469 | 0.1173 | 1.0000 | 0.0000 |
| 5 | Wernicke | 0.2228 | 0.0000 | 0.1065 | 0.6361 |
...
|---|---|---|---|
| IFG | std_intensity | 0.0476 | increases |
| Wernicke | std_intensity | 0.0400 | increases |
| Broca | std_intensity | 0.0394 | increases |
| Broca | entropy | 0.0124 | increases |
| STG | kurtosis | 0.0112 | increases |
| STG | voxel_count | 0.0091 | increases |
| Broca | voxel_count | 0.0073 | increases |
| Insula | normalized_volume | 0.0067 | increases |
| IFG | kurtosis | 0.0049 | increases |
| STG | gm_volume_mm3 | 0.0008 | increases |
