...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0035_MR1` |
| Generated | 2026-09-21 23:26:27 |
...
- Top-class probability: 0.4962
- Margin over runner-up: 0.1990
- Normalised predictive entropy: 0.9413 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | STG | 0.7661 | Auditory-verbal processing, spectrotemporal analysis |
| 2 | Insula | 0.7438 | Articulatory planning, phonological awareness |
| 3 | Broca | 0.5105 | Speech production, phonological encoding |
| 4 | Wernicke | 0.4680 | Speech comprehension, auditory word recognition |
| 5 | IFG | 0.4328 | Syntactic processing, verbal working memory |
...
|---|---|---|---|
| STG -> Insula | 0.1973 | 0.8106 | Extreme_Capsule_System |
| Wernicke -> Insula | 0.1913 | 0.8056 | Extreme_Capsule_System |
| Broca -> Wernicke | 0.1852 | 0.8058 | Superior_Longitudinal_Fasciculus |
| IFG -> Wernicke | 0.1847 | 0.7961 | no prior edge |
| Insula -> STG | 0.1837 | 0.8032 | no prior edge |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.7375 |
| AD-associated propensity | 0.5064 |
...
|---|---|---|---|---|---|
| 1 | Insula | 0.9202 | 0.9333 | 1.0000 | 0.8229 |
| 2 | STG | 0.7149 | 1.0000 | 0.8490 | 0.2007 |
| 3 | Broca | 0.4264 | 0.2332 | 0.1104 | 1.0000 |
| 4 | Wernicke | 0.3967 | 0.1057 | 0.8095 | 0.3720 |
| 5 | IFG | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
...
|---|---|---|---|
| Insula | gm_volume_mm3 | 0.0311 | increases |
| Broca | surface_to_volume_ratio | 0.0263 | increases |
| Insula | normalized_volume | 0.0217 | increases |
| Wernicke | atrophy_index | 0.0180 | increases |
| Broca | skewness | 0.0175 | increases |
| Broca | kurtosis | 0.0170 | increases |
| IFG | surface_to_volume_ratio | 0.0158 | increases |
| Wernicke | surface_area_vox | 0.0145 | increases |
| STG | surface_to_volume_ratio | 0.0139 | increases |
| STG | gm_volume_mm3 | 0.0109 | increases |
