...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0021_MR1` |
| Generated | 2026-09-21 23:26:15 |
...
- Top-class probability: 0.5208
- Margin over runner-up: 0.1692
- Normalised predictive entropy: 0.8830 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Broca | 0.8891 | Speech production, phonological encoding |
| 2 | STG | 0.6148 | Auditory-verbal processing, spectrotemporal analysis |
| 3 | Wernicke | 0.4687 | Speech comprehension, auditory word recognition |
| 4 | Insula | 0.3355 | Articulatory planning, phonological awareness |
| 5 | IFG | 0.3211 | Syntactic processing, verbal working memory |
...
|---|---|---|---|
| Insula -> Broca | 0.1860 | 0.8099 | Short_Arcuate_Fibres |
| IFG -> Broca | 0.1808 | 0.8104 | Within_IFG_Fibres |
| Wernicke -> Broca | 0.1790 | 0.8099 | Superior_Longitudinal_Fasciculus |
| STG -> Broca | 0.1741 | 0.8021 | no prior edge |
| STG -> Wernicke | 0.1636 | 0.8120 | Intra_STG_Fibres |
...
| STG -> Broca | 0.6947 |
| Broca -> STG | 0.6905 |
| Wernicke -> Broca | 0.6866 |
| Broca -> Wernicke | 0.6807 |
| IFG -> Broca | 0.6786 |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.3553 |
| AD-associated propensity | 0.5075 |
| Stage-transition propensity | 0.4501 |
...
|---|---|---|---|---|---|
| 1 | Broca | 0.7564 | 1.0000 | 1.0000 | 0.1880 |
| 2 | STG | 0.5817 | 0.5170 | 0.3370 | 0.9125 |
| 3 | Wernicke | 0.3428 | 0.2599 | 0.3820 | 0.4140 |
| 4 | IFG | 0.3000 | 0.0000 | 0.0000 | 1.0000 |
| 5 | Insula | 0.0812 | 0.0253 | 0.2371 | 0.0000 |
...
|---|---|---|---|
| STG | normalized_volume | 0.0545 | increases |
| Broca | normalized_volume | 0.0360 | increases |
| IFG | normalized_volume | 0.0336 | increases |
| Wernicke | normalized_volume | 0.0333 | increases |
| Insula | normalized_volume | 0.0284 | increases |
| IFG | gm_fraction | 0.0131 | increases |
| IFG | cortical_thickness_mm | 0.0125 | increases |
| Wernicke | surface_area_vox | 0.0119 | increases |
| STG | atrophy_index | 0.0110 | increases |
| IFG | surface_area_vox | 0.0098 | increases |
