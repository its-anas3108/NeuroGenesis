...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0028_MR1` |
| Generated | 2026-09-21 23:26:20 |
...
- Top-class probability: 0.6469
- Margin over runner-up: 0.4358
- Normalised predictive entropy: 0.8076 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Insula | 0.9144 | Articulatory planning, phonological awareness |
| 2 | Broca | 0.8071 | Speech production, phonological encoding |
| 3 | Wernicke | 0.4879 | Speech comprehension, auditory word recognition |
| 4 | IFG | 0.4207 | Syntactic processing, verbal working memory |
| 5 | STG | 0.3749 | Auditory-verbal processing, spectrotemporal analysis |
...
|---|---|---|---|
| IFG -> Insula | 0.2039 | 0.8076 | Inferior_Fronto_Occipital_Fasciculus |
| Broca -> Insula | 0.1974 | 0.8114 | Short_Arcuate_Fibres |
| Wernicke -> Insula | 0.1929 | 0.8078 | Extreme_Capsule_System |
| STG -> Insula | 0.1900 | 0.8079 | Extreme_Capsule_System |
| Insula -> Wernicke | 0.1792 | 0.8112 | Extreme_Capsule_System |
...
| Insula -> Broca | 0.7274 |
| IFG -> Insula | 0.6906 |
| Insula -> Wernicke | 0.6840 |
| Wernicke -> Insula | 0.6839 |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.5382 |
| AD-associated propensity | 0.4958 |
...
|---|---|---|---|---|---|
| 1 | Insula | 0.7659 | 1.0000 | 1.0000 | 0.2198 |
| 2 | Broca | 0.7116 | 0.8011 | 0.3037 | 1.0000 |
| 3 | Wernicke | 0.2886 | 0.2096 | 0.6827 | 0.0000 |
| 4 | STG | 0.1518 | 0.0000 | 0.1318 | 0.3742 |
| 5 | IFG | 0.1091 | 0.0849 | 0.0000 | 0.2504 |
...
|---|---|---|---|
| Broca | surface_area_vox | 0.0465 | increases |
| IFG | surface_area_vox | 0.0458 | increases |
| Broca | surface_to_volume_ratio | 0.0409 | increases |
| STG | gm_fraction | 0.0360 | increases |
| Broca | gm_volume_mm3 | 0.0329 | increases |
| STG | skewness | 0.0324 | increases |
| Broca | entropy | 0.0316 | increases |
| Broca | brain_volume_mm3 | 0.0310 | increases |
| Insula | voxel_count | 0.0253 | increases |
| Insula | skewness | 0.0149 | increases |
