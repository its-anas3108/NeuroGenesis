...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0034_MR1` |
| Generated | 2026-09-21 23:26:26 |
...
- Top-class probability: 0.6326
- Margin over runner-up: 0.3635
- Normalised predictive entropy: 0.7927 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | IFG | 0.8868 | Syntactic processing, verbal working memory |
| 2 | Wernicke | 0.8255 | Speech comprehension, auditory word recognition |
| 3 | Broca | 0.7833 | Speech production, phonological encoding |
| 4 | STG | 0.5320 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Insula | 0.4986 | Articulatory planning, phonological awareness |
...
|---|---|---|---|
| Wernicke -> Broca | 0.1742 | 0.8126 | Superior_Longitudinal_Fasciculus |
| IFG -> STG | 0.1737 | 0.8073 | Inferior_Fronto_Occipital_Fasciculus |
| STG -> Insula | 0.1715 | 0.8056 | Extreme_Capsule_System |
| Insula -> Wernicke | 0.1706 | 0.8105 | Extreme_Capsule_System |
| STG -> Broca | 0.1706 | 0.8005 | no prior edge |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.4174 |
| AD-associated propensity | 0.4744 |
| Stage-transition propensity | 0.5068 |
...
|---|---|---|---|---|---|
| 1 | Broca | 0.7603 | 0.7334 | 1.0000 | 0.5566 |
| 2 | IFG | 0.7000 | 1.0000 | 0.0000 | 1.0000 |
| 3 | Wernicke | 0.5945 | 0.8420 | 0.8457 | 0.0134 |
| 4 | Insula | 0.2844 | 0.0000 | 0.9479 | 0.0000 |
| 5 | STG | 0.2528 | 0.0860 | 0.4025 | 0.3256 |
...
|---|---|---|---|
| IFG | std_intensity | 0.0538 | increases |
| STG | surface_to_volume_ratio | 0.0270 | increases |
| Broca | surface_area_vox | 0.0251 | increases |
| IFG | surface_area_vox | 0.0242 | increases |
| IFG | gm_volume_mm3 | 0.0186 | increases |
| Broca | std_intensity | 0.0185 | increases |
| Broca | surface_to_volume_ratio | 0.0153 | increases |
| Wernicke | std_intensity | 0.0127 | increases |
| STG | kurtosis | 0.0122 | increases |
| Insula | brain_volume_mm3 | 0.0116 | increases |
