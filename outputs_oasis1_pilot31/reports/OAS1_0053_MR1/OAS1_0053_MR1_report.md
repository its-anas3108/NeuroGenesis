...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0053_MR1` |
| Generated | 2026-09-21 23:26:36 |
...
- Top-class probability: 0.6311
- Margin over runner-up: 0.3483
- Normalised predictive entropy: 0.7817 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Insula | 0.9548 | Articulatory planning, phonological awareness |
| 2 | Broca | 0.4498 | Speech production, phonological encoding |
| 3 | IFG | 0.3349 | Syntactic processing, verbal working memory |
| 4 | Wernicke | 0.2026 | Speech comprehension, auditory word recognition |
| 5 | STG | 0.1957 | Auditory-verbal processing, spectrotemporal analysis |
...
|---|---|---|---|
| Wernicke -> Insula | 0.1881 | 0.8051 | Extreme_Capsule_System |
| STG -> Insula | 0.1869 | 0.8064 | Extreme_Capsule_System |
| Broca -> Wernicke | 0.1829 | 0.8022 | Superior_Longitudinal_Fasciculus |
| Broca -> Insula | 0.1808 | 0.8089 | Short_Arcuate_Fibres |
| IFG -> Insula | 0.1795 | 0.8075 | Inferior_Fronto_Occipital_Fasciculus |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.8399 |
| AD-associated propensity | 0.4690 |
...
| 2 | IFG | 0.3131 | 0.1833 | 0.0000 | 0.7993 |
| 3 | Wernicke | 0.2997 | 0.0091 | 0.7773 | 0.2095 |
| 4 | STG | 0.2868 | 0.0000 | 0.2950 | 0.6610 |
| 5 | Broca | 0.2451 | 0.3347 | 0.3707 | 0.0000 |
...
|---|---|---|---|
| Insula | surface_to_volume_ratio | 0.0460 | increases |
| STG | std_intensity | 0.0383 | increases |
| Wernicke | gm_fraction | 0.0368 | increases |
| STG | entropy | 0.0368 | increases |
| IFG | gm_fraction | 0.0359 | increases |
| IFG | brain_volume_mm3 | 0.0341 | increases |
| Insula | gm_fraction | 0.0331 | increases |
| Insula | normalized_volume | 0.0246 | increases |
| Broca | surface_to_volume_ratio | 0.0190 | increases |
| IFG | skewness | 0.0168 | increases |
