...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0022_MR1` |
| Generated | 2026-09-21 23:26:16 |
...
- Top-class probability: 0.3648
- Margin over runner-up: 0.0461
- Normalised predictive entropy: 0.9980 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | IFG | 0.4479 | Syntactic processing, verbal working memory |
| 2 | Insula | 0.4199 | Articulatory planning, phonological awareness |
| 3 | Wernicke | 0.3856 | Speech comprehension, auditory word recognition |
| 4 | STG | 0.3082 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Broca | 0.2256 | Speech production, phonological encoding |
...
|---|---|---|---|
| STG -> Insula | 0.1960 | 0.8029 | Extreme_Capsule_System |
| Wernicke -> Insula | 0.1915 | 0.8025 | Extreme_Capsule_System |
| STG -> Wernicke | 0.1873 | 0.8076 | Intra_STG_Fibres |
| Broca -> Insula | 0.1869 | 0.8008 | Short_Arcuate_Fibres |
| IFG -> Insula | 0.1848 | 0.8031 | Inferior_Fronto_Occipital_Fasciculus |

### Highest propagation-representation pathways (NeuroProp-X ANP)

| Pathway | Propagation score |
|---|---|
| Insula -> Wernicke | 0.6315 |
| Wernicke -> Insula | 0.6284 |
| IFG -> Insula | 0.6259 |
| STG -> Insula | 0.6205 |
| STG -> Wernicke | 0.6193 |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.3001 |
| AD-associated propensity | 0.4676 |
| Stage-transition propensity | 0.3594 |
...
|---|---|---|---|---|---|
| 1 | IFG | 0.7000 | 1.0000 | 0.0000 | 1.0000 |
| 2 | Insula | 0.6497 | 0.8743 | 1.0000 | 0.0000 |
| 3 | Wernicke | 0.5642 | 0.7196 | 0.8453 | 0.0760 |
| 4 | STG | 0.3166 | 0.3715 | 0.3192 | 0.2409 |
| 5 | Broca | 0.2008 | 0.0000 | 0.0424 | 0.6268 |
...
|---|---|---|---|
| Broca | entropy | -0.0143 | decreases |
| IFG | voxel_count | -0.0086 | decreases |
| IFG | mean_intensity | -0.0047 | decreases |
| IFG | kurtosis | -0.0044 | decreases |
| IFG | surface_area_vox | -0.0037 | decreases |
| IFG | std_intensity | -0.0037 | decreases |
| STG | gm_fraction | -0.0030 | decreases |
| STG | mean_intensity | -0.0030 | decreases |
| Wernicke | normalized_volume | -0.0019 | decreases |
| Broca | skewness | -0.0014 | decreases |
