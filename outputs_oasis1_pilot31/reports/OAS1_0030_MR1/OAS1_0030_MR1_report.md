...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0030_MR1` |
| Generated | 2026-09-21 23:26:21 |
...
- Top-class probability: 0.7030
- Margin over runner-up: 0.5179
- Normalised predictive entropy: 0.7329 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Insula | 0.7508 | Articulatory planning, phonological awareness |
| 2 | STG | 0.4179 | Auditory-verbal processing, spectrotemporal analysis |
| 3 | IFG | 0.3957 | Syntactic processing, verbal working memory |
| 4 | Broca | 0.3774 | Speech production, phonological encoding |
| 5 | Wernicke | 0.2998 | Speech comprehension, auditory word recognition |
...
|---|---|---|---|
| STG -> Broca | 0.1973 | 0.7946 | no prior edge |
| Insula -> Broca | 0.1911 | 0.8088 | Short_Arcuate_Fibres |
| IFG -> STG | 0.1868 | 0.8009 | Inferior_Fronto_Occipital_Fasciculus |
| Wernicke -> Broca | 0.1862 | 0.8031 | Superior_Longitudinal_Fasciculus |
| Insula -> IFG | 0.1775 | 0.7986 | no prior edge |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.5180 |
| AD-associated propensity | 0.4567 |
...
|---|---|---|---|---|---|
| 1 | Insula | 0.7000 | 1.0000 | 0.0000 | 1.0000 |
| 2 | STG | 0.5133 | 0.2620 | 0.8329 | 0.5286 |
| 3 | Broca | 0.4544 | 0.1722 | 1.0000 | 0.2850 |
| 4 | IFG | 0.4516 | 0.2128 | 0.6511 | 0.5703 |
| 5 | Wernicke | 0.1788 | 0.0000 | 0.5960 | 0.0000 |
...
|---|---|---|---|
| Insula | surface_to_volume_ratio | 0.0718 | increases |
| Insula | surface_area_vox | 0.0549 | increases |
| STG | entropy | 0.0474 | increases |
| Broca | normalized_volume | 0.0470 | increases |
| IFG | std_intensity | 0.0389 | increases |
| Insula | brain_volume_mm3 | 0.0383 | increases |
| IFG | skewness | 0.0340 | increases |
| STG | surface_area_vox | 0.0319 | increases |
| IFG | entropy | 0.0212 | increases |
| STG | atrophy_index | 0.0080 | increases |
