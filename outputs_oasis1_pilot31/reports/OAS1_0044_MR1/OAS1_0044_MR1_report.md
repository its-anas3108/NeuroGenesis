...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0044_MR1` |
| Generated | 2026-09-21 23:26:32 |
...
- Top-class probability: 0.5340
- Margin over runner-up: 0.1854
- Normalised predictive entropy: 0.8683 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | STG | 0.7356 | Auditory-verbal processing, spectrotemporal analysis |
| 2 | IFG | 0.7210 | Syntactic processing, verbal working memory |
| 3 | Wernicke | 0.6578 | Speech comprehension, auditory word recognition |
| 4 | Insula | 0.6486 | Articulatory planning, phonological awareness |
| 5 | Broca | 0.6182 | Speech production, phonological encoding |
...
|---|---|---|---|
| Insula -> Broca | 0.2035 | 0.8106 | Short_Arcuate_Fibres |
| STG -> Broca | 0.1917 | 0.8008 | no prior edge |
| Wernicke -> Broca | 0.1885 | 0.8095 | Superior_Longitudinal_Fasciculus |
| IFG -> Broca | 0.1753 | 0.8124 | Within_IFG_Fibres |
| Insula -> IFG | 0.1723 | 0.8013 | no prior edge |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.3334 |
| AD-associated propensity | 0.4555 |
| Stage-transition propensity | 0.3491 |
...
|---|---|---|---|---|---|
| 1 | IFG | 0.8132 | 0.8753 | 0.5436 | 1.0000 |
| 2 | Broca | 0.5640 | 0.0000 | 1.0000 | 0.8799 |
| 3 | STG | 0.5193 | 1.0000 | 0.3267 | 0.0709 |
| 4 | Wernicke | 0.2576 | 0.3373 | 0.0000 | 0.4091 |
| 5 | Insula | 0.2158 | 0.2594 | 0.3736 | 0.0000 |
...
|---|---|---|---|
| IFG | brain_volume_mm3 | 0.0400 | increases |
| Broca | brain_volume_mm3 | 0.0232 | increases |
| Wernicke | surface_area_vox | 0.0187 | increases |
| Broca | surface_area_vox | 0.0105 | increases |
| Broca | surface_to_volume_ratio | 0.0097 | increases |
| STG | mean_intensity | 0.0052 | increases |
| IFG | surface_to_volume_ratio | 0.0047 | increases |
| IFG | surface_area_vox | 0.0044 | increases |
| Wernicke | std_intensity | 0.0024 | increases |
| Insula | brain_volume_mm3 | 0.0019 | increases |
