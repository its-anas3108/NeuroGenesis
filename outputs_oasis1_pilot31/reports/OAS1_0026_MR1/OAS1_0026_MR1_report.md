...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0026_MR1` |
| Generated | 2026-09-21 23:26:19 |
...
- Top-class probability: 0.5512
- Margin over runner-up: 0.2847
- Normalised predictive entropy: 0.9020 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Broca | 0.8444 | Speech production, phonological encoding |
| 2 | IFG | 0.7808 | Syntactic processing, verbal working memory |
| 3 | STG | 0.5701 | Auditory-verbal processing, spectrotemporal analysis |
| 4 | Insula | 0.4520 | Articulatory planning, phonological awareness |
| 5 | Wernicke | 0.1551 | Speech comprehension, auditory word recognition |
...
|---|---|---|---|
| STG -> Broca | 0.1837 | 0.8018 | no prior edge |
| IFG -> Broca | 0.1836 | 0.8148 | Within_IFG_Fibres |
| Insula -> Broca | 0.1822 | 0.8111 | Short_Arcuate_Fibres |
| Insula -> IFG | 0.1712 | 0.8001 | no prior edge |
| STG -> IFG | 0.1706 | 0.8013 | no prior edge |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.1365 |
| AD-associated propensity | 0.4521 |
| Stage-transition propensity | 0.1596 |
...
|---|---|---|---|---|---|
| 1 | Broca | 0.7879 | 1.0000 | 1.0000 | 0.2929 |
| 2 | IFG | 0.7013 | 0.9078 | 0.6984 | 0.4289 |
| 3 | Insula | 0.6689 | 0.4308 | 0.6551 | 1.0000 |
| 4 | STG | 0.3766 | 0.6021 | 0.0000 | 0.4525 |
| 5 | Wernicke | 0.1565 | 0.0000 | 0.5216 | 0.0000 |
...
|---|---|---|---|
| Insula | surface_to_volume_ratio | 0.0329 | increases |
| IFG | brain_volume_mm3 | 0.0272 | increases |
| Broca | gm_volume_mm3 | 0.0193 | increases |
| Insula | cortical_thickness_mm | 0.0139 | increases |
| STG | entropy | 0.0115 | increases |
| Insula | normalized_volume | 0.0105 | increases |
| STG | surface_to_volume_ratio | 0.0104 | increases |
| STG | atrophy_index | 0.0068 | increases |
| Insula | brain_volume_mm3 | 0.0031 | increases |
| Wernicke | surface_area_vox | 0.0023 | increases |
