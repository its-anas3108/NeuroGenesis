...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0041_MR1` |
| Generated | 2026-09-21 23:26:30 |
...
- Top-class probability: 0.5036
- Margin over runner-up: 0.2481
- Normalised predictive entropy: 0.9439 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | STG | 0.7586 | Auditory-verbal processing, spectrotemporal analysis |
| 2 | Wernicke | 0.7336 | Speech comprehension, auditory word recognition |
| 3 | Broca | 0.5362 | Speech production, phonological encoding |
| 4 | IFG | 0.4439 | Syntactic processing, verbal working memory |
| 5 | Insula | 0.3084 | Articulatory planning, phonological awareness |
...
|---|---|---|---|
| Wernicke -> STG | 0.1962 | 0.8110 | Intra_STG_Fibres |
| Insula -> STG | 0.1931 | 0.7976 | no prior edge |
| Broca -> STG | 0.1918 | 0.8001 | no prior edge |
| IFG -> STG | 0.1846 | 0.8049 | Inferior_Fronto_Occipital_Fasciculus |
| Insula -> Broca | 0.1796 | 0.8065 | Short_Arcuate_Fibres |
...
| STG -> Wernicke | 0.7047 |
| Wernicke -> STG | 0.7016 |
| Wernicke -> Broca | 0.6761 |
| Broca -> Wernicke | 0.6755 |
| Broca -> STG | 0.6700 |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.2849 |
| AD-associated propensity | 0.4390 |
| Stage-transition propensity | 0.3262 |
...
|---|---|---|---|---|---|
| 1 | Wernicke | 0.8659 | 0.9445 | 0.6271 | 1.0000 |
| 2 | STG | 0.7000 | 1.0000 | 1.0000 | 0.0000 |
| 3 | Broca | 0.5835 | 0.5060 | 0.7606 | 0.5096 |
| 4 | IFG | 0.2081 | 0.3011 | 0.2320 | 0.0604 |
| 5 | Insula | 0.1358 | 0.0000 | 0.0000 | 0.4528 |
...
|---|---|---|---|
| Insula | surface_to_volume_ratio | 0.0152 | increases |
| Broca | mean_intensity | 0.0149 | increases |
| Wernicke | gm_fraction | 0.0141 | increases |
| Wernicke | brain_volume_mm3 | 0.0120 | increases |
| IFG | skewness | 0.0089 | increases |
| STG | surface_area_vox | 0.0073 | increases |
| Broca | std_intensity | 0.0059 | increases |
| Wernicke | surface_area_vox | 0.0042 | increases |
| Insula | cortical_thickness_mm | 0.0042 | increases |
| Wernicke | atrophy_index | 0.0034 | increases |
