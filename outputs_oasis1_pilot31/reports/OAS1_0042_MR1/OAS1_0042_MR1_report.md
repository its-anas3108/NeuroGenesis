...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0042_MR1` |
| Generated | 2026-09-21 23:26:31 |
...
Reference CDR-derived stage for this session: **MCI**. The model's assignment agrees with it.

### Model confidence

- Top-class probability: 0.5757
- Margin over runner-up: 0.3089
- Normalised predictive entropy: 0.8752 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Wernicke | 0.7288 | Speech comprehension, auditory word recognition |
| 2 | Insula | 0.6781 | Articulatory planning, phonological awareness |
| 3 | IFG | 0.1054 | Syntactic processing, verbal working memory |
| 4 | STG | 0.0932 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Broca | 0.0538 | Speech production, phonological encoding |
...
|---|---|---|---|
| Insula -> IFG | 0.1816 | 0.7950 | no prior edge |
| STG -> Insula | 0.1800 | 0.8027 | Extreme_Capsule_System |
| Wernicke -> IFG | 0.1744 | 0.7955 | no prior edge |
| Wernicke -> Broca | 0.1732 | 0.8045 | Superior_Longitudinal_Fasciculus |
| Insula -> Broca | 0.1725 | 0.8052 | Short_Arcuate_Fibres |

### Highest propagation-representation pathways (NeuroProp-X ANP)

| Pathway | Propagation score |
|---|---|
| Insula -> Wernicke | 0.7022 |
| Wernicke -> Insula | 0.6915 |
| STG -> Wernicke | 0.6359 |
| Wernicke -> STG | 0.6234 |
| STG -> Insula | 0.6204 |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.4413 |
| AD-associated propensity | 0.5153 |
| Stage-transition propensity | 0.3765 |
...
|---|---|---|---|---|---|
| 1 | Wernicke | 0.6913 | 1.0000 | 0.0000 | 0.9710 |
| 2 | Insula | 0.6886 | 0.9249 | 1.0000 | 0.0621 |
| 3 | Broca | 0.5844 | 0.0000 | 0.9478 | 1.0000 |
| 4 | IFG | 0.3622 | 0.0765 | 0.9966 | 0.1086 |
| 5 | STG | 0.1744 | 0.0584 | 0.5035 | 0.0000 |
...
|---|---|---|---|
| Wernicke | normalized_volume | 0.0600 | increases |
| Broca | normalized_volume | 0.0420 | increases |
| Wernicke | gm_fraction | 0.0342 | increases |
| IFG | normalized_volume | 0.0318 | increases |
| Insula | normalized_volume | 0.0278 | increases |
| Broca | surface_area_vox | 0.0269 | increases |
| STG | mean_intensity | 0.0223 | increases |
| Broca | brain_volume_mm3 | 0.0223 | increases |
| Broca | kurtosis | 0.0184 | increases |
| Wernicke | mean_intensity | 0.0130 | increases |
