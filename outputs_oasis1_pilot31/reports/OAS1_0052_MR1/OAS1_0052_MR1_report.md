...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0052_MR1` |
| Generated | 2026-09-21 23:26:34 |
...
Reference CDR-derived stage for this session: **AD**. The model's assignment differs from it.

### Model confidence

- Top-class probability: 0.5775
- Margin over runner-up: 0.3463
- Normalised predictive entropy: 0.8848 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Broca | 0.8625 | Speech production, phonological encoding |
| 2 | IFG | 0.7674 | Syntactic processing, verbal working memory |
| 3 | Insula | 0.6805 | Articulatory planning, phonological awareness |
| 4 | Wernicke | 0.5566 | Speech comprehension, auditory word recognition |
| 5 | STG | 0.3036 | Auditory-verbal processing, spectrotemporal analysis |
...
|---|---|---|---|
| IFG -> Broca | 0.1899 | 0.8151 | Within_IFG_Fibres |
| Wernicke -> Broca | 0.1883 | 0.8111 | Superior_Longitudinal_Fasciculus |
| STG -> Broca | 0.1881 | 0.7988 | no prior edge |
| Insula -> Broca | 0.1811 | 0.8135 | Short_Arcuate_Fibres |
| Wernicke -> IFG | 0.1771 | 0.8008 | no prior edge |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.7059 |
| AD-associated propensity | 0.5028 |
| Stage-transition propensity | 0.8707 |
...
|---|---|---|---|---|---|
| 1 | IFG | 0.7881 | 0.8300 | 0.6385 | 0.8820 |
| 2 | Broca | 0.7000 | 1.0000 | 1.0000 | 0.0000 |
| 3 | Insula | 0.6639 | 0.6743 | 0.3138 | 1.0000 |
| 4 | STG | 0.3893 | 0.0000 | 0.6133 | 0.6845 |
| 5 | Wernicke | 0.3144 | 0.4527 | 0.0000 | 0.4445 |
...
|---|---|---|---|
| IFG | mean_intensity | 0.0547 | increases |
| STG | normalized_volume | 0.0352 | increases |
| Insula | gm_volume_mm3 | 0.0340 | increases |
| IFG | gm_fraction | 0.0334 | increases |
| STG | std_intensity | 0.0331 | increases |
| Wernicke | normalized_volume | 0.0287 | increases |
| Insula | mean_intensity | 0.0250 | increases |
| Insula | normalized_volume | 0.0244 | increases |
| Insula | cortical_thickness_mm | 0.0165 | increases |
| Wernicke | entropy | 0.0157 | increases |
