...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0023_MR1` |
| Generated | 2026-09-21 23:26:17 |
...
- Top-class probability: 0.4234
- Margin over runner-up: 0.0802
- Normalised predictive entropy: 0.9744 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Insula | 0.5302 | Articulatory planning, phonological awareness |
| 2 | Wernicke | 0.4876 | Speech comprehension, auditory word recognition |
| 3 | STG | 0.2893 | Auditory-verbal processing, spectrotemporal analysis |
| 4 | Broca | 0.1654 | Speech production, phonological encoding |
| 5 | IFG | 0.1526 | Syntactic processing, verbal working memory |
...
|---|---|---|---|
| STG -> Insula | 0.2300 | 0.8035 | Extreme_Capsule_System |
| Wernicke -> Insula | 0.2153 | 0.8041 | Extreme_Capsule_System |
| Broca -> Insula | 0.2152 | 0.8014 | Short_Arcuate_Fibres |
| IFG -> Insula | 0.2121 | 0.8011 | Inferior_Fronto_Occipital_Fasciculus |
| IFG -> Broca | 0.1708 | 0.8021 | Within_IFG_Fibres |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.6188 |
| AD-associated propensity | 0.4881 |
...
|---|---|---|---|---|---|
| 1 | Insula | 0.7270 | 1.0000 | 1.0000 | 0.0901 |
| 2 | Wernicke | 0.6559 | 0.8872 | 0.0033 | 1.0000 |
| 3 | Broca | 0.1839 | 0.0338 | 0.3051 | 0.2629 |
| 4 | STG | 0.1725 | 0.3619 | 0.0000 | 0.0924 |
| 5 | IFG | 0.0365 | 0.0000 | 0.1217 | 0.0000 |
...
|---|---|---|---|
| Wernicke | brain_volume_mm3 | 0.0179 | increases |
| Wernicke | surface_area_vox | 0.0178 | increases |
| Wernicke | surface_to_volume_ratio | 0.0165 | increases |
| STG | surface_to_volume_ratio | 0.0137 | increases |
| Insula | voxel_count | 0.0136 | increases |
| IFG | cortical_thickness_mm | 0.0095 | increases |
| Broca | kurtosis | 0.0083 | increases |
| Broca | surface_area_vox | 0.0080 | increases |
| Broca | normalized_volume | 0.0051 | increases |
| Wernicke | entropy | 0.0030 | increases |
