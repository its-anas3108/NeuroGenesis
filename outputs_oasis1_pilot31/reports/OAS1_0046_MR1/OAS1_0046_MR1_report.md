...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0046_MR1` |
| Generated | 2026-09-21 23:26:33 |
...
- Top-class probability: 0.5285
- Margin over runner-up: 0.2095
- Normalised predictive entropy: 0.8995 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Wernicke | 0.8157 | Speech comprehension, auditory word recognition |
| 2 | IFG | 0.4198 | Syntactic processing, verbal working memory |
| 3 | Broca | 0.4104 | Speech production, phonological encoding |
| 4 | STG | 0.3440 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Insula | 0.3019 | Articulatory planning, phonological awareness |
...
|---|---|---|---|
| STG -> Broca | 0.1881 | 0.7945 | no prior edge |
| Broca -> Wernicke | 0.1843 | 0.8081 | Superior_Longitudinal_Fasciculus |
| IFG -> Broca | 0.1838 | 0.8073 | Within_IFG_Fibres |
| Insula -> Wernicke | 0.1831 | 0.8081 | Extreme_Capsule_System |
| STG -> Wernicke | 0.1748 | 0.8121 | Intra_STG_Fibres |
...
| STG -> Wernicke | 0.6737 |
| Wernicke -> STG | 0.6664 |
| Wernicke -> Broca | 0.6651 |
| Broca -> Wernicke | 0.6646 |
| IFG -> Wernicke | 0.6561 |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.2039 |
| AD-associated propensity | 0.4504 |
| Stage-transition propensity | 0.2216 |
...
|---|---|---|---|---|---|
| 1 | Wernicke | 0.7680 | 1.0000 | 1.0000 | 0.2268 |
| 2 | Broca | 0.6138 | 0.2111 | 0.9898 | 0.7746 |
| 3 | STG | 0.3838 | 0.0819 | 0.1701 | 1.0000 |
| 4 | Insula | 0.2734 | 0.0000 | 0.0000 | 0.9115 |
| 5 | IFG | 0.2204 | 0.2294 | 0.4288 | 0.0000 |
...
|---|---|---|---|
| Insula | gm_volume_mm3 | 0.0302 | increases |
| Broca | brain_volume_mm3 | 0.0207 | increases |
| STG | gm_volume_mm3 | 0.0204 | increases |
| Broca | surface_to_volume_ratio | 0.0099 | increases |
| STG | brain_volume_mm3 | 0.0093 | increases |
| Wernicke | brain_volume_mm3 | 0.0090 | increases |
| STG | kurtosis | 0.0051 | increases |
| STG | atrophy_index | 0.0047 | increases |
| Insula | surface_to_volume_ratio | 0.0046 | increases |
| Insula | brain_volume_mm3 | 0.0013 | increases |
