...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0039_MR1` |
| Generated | 2026-09-21 23:26:28 |
...
- Top-class probability: 0.5308
- Margin over runner-up: 0.2148
- Normalised predictive entropy: 0.8990 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Broca | 0.8239 | Speech production, phonological encoding |
| 2 | IFG | 0.5037 | Syntactic processing, verbal working memory |
| 3 | Insula | 0.3606 | Articulatory planning, phonological awareness |
| 4 | STG | 0.3427 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Wernicke | 0.2417 | Speech comprehension, auditory word recognition |
...
|---|---|---|---|
| STG -> Broca | 0.2167 | 0.7989 | no prior edge |
| Wernicke -> Broca | 0.2163 | 0.8071 | Superior_Longitudinal_Fasciculus |
| Insula -> Broca | 0.2139 | 0.8095 | Short_Arcuate_Fibres |
| IFG -> Broca | 0.2086 | 0.8120 | Within_IFG_Fibres |
| Broca -> IFG | 0.1684 | 0.8106 | Within_IFG_Fibres |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.6288 |
| AD-associated propensity | 0.5109 |
| Stage-transition propensity | 0.9373 |
...
|---|---|---|---|---|---|
| 1 | Broca | 0.7418 | 1.0000 | 1.0000 | 0.1394 |
| 2 | IFG | 0.5957 | 0.4501 | 0.3854 | 1.0000 |
| 3 | Insula | 0.3121 | 0.2042 | 0.0000 | 0.7680 |
| 4 | STG | 0.2143 | 0.1734 | 0.0176 | 0.4656 |
| 5 | Wernicke | 0.0621 | 0.0000 | 0.2068 | 0.0000 |
...
|---|---|---|---|
| Insula | normalized_volume | 0.0392 | increases |
| IFG | gm_fraction | 0.0381 | increases |
| Insula | surface_area_vox | 0.0349 | increases |
| IFG | mean_intensity | 0.0337 | increases |
| Broca | entropy | 0.0242 | increases |
| STG | normalized_volume | 0.0240 | increases |
| IFG | normalized_volume | 0.0206 | increases |
| STG | mean_intensity | 0.0171 | increases |
| Wernicke | std_intensity | 0.0131 | increases |
| STG | brain_volume_mm3 | 0.0089 | increases |
