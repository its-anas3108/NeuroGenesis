...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0013_MR1` |
| Generated | 2026-09-21 23:26:07 |
...
- Top-class probability: 0.4336
- Margin over runner-up: 0.0290
- Normalised predictive entropy: 0.9312 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Broca | 0.7610 | Speech production, phonological encoding |
| 2 | IFG | 0.4819 | Syntactic processing, verbal working memory |
| 3 | Insula | 0.3042 | Articulatory planning, phonological awareness |
| 4 | Wernicke | 0.2537 | Speech comprehension, auditory word recognition |
| 5 | STG | 0.2308 | Auditory-verbal processing, spectrotemporal analysis |
...
|---|---|---|---|
| IFG -> Broca | 0.1893 | 0.8114 | Within_IFG_Fibres |
| Insula -> Broca | 0.1850 | 0.8085 | Short_Arcuate_Fibres |
| STG -> Broca | 0.1809 | 0.7967 | no prior edge |
| Wernicke -> Broca | 0.1768 | 0.8065 | Superior_Longitudinal_Fasciculus |
| Insula -> IFG | 0.1702 | 0.7949 | no prior edge |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.2904 |
| AD-associated propensity | 0.4850 |
| Stage-transition propensity | 0.6308 |
...
|---|---|---|---|---|---|
| 1 | Broca | 1.0000 | 1.0000 | 1.0000 | 1.0000 |
| 2 | IFG | 0.5272 | 0.4737 | 0.5613 | 0.5646 |
| 3 | Insula | 0.3968 | 0.1385 | 0.4341 | 0.7040 |
| 4 | Wernicke | 0.2100 | 0.0432 | 0.0000 | 0.6423 |
| 5 | STG | 0.0365 | 0.0000 | 0.1217 | 0.0000 |
...
|---|---|---|---|
| Insula | normalized_volume | 0.0362 | increases |
| Broca | normalized_volume | 0.0191 | increases |
| Wernicke | entropy | 0.0179 | increases |
| Wernicke | normalized_volume | 0.0158 | increases |
| Broca | gm_fraction | 0.0149 | increases |
| IFG | normalized_volume | 0.0144 | increases |
| Broca | mean_intensity | 0.0138 | increases |
| IFG | mean_intensity | 0.0092 | increases |
| STG | normalized_volume | 0.0084 | increases |
| IFG | surface_to_volume_ratio | 0.0071 | increases |
