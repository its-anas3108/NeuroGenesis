...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0020_MR1` |
| Generated | 2026-09-21 23:26:13 |
...
- Top-class probability: 0.5201
- Margin over runner-up: 0.2263
- Normalised predictive entropy: 0.9219 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | IFG | 0.6929 | Syntactic processing, verbal working memory |
| 2 | Broca | 0.6264 | Speech production, phonological encoding |
| 3 | Insula | 0.5056 | Articulatory planning, phonological awareness |
| 4 | STG | 0.4655 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Wernicke | 0.3832 | Speech comprehension, auditory word recognition |
...
|---|---|---|---|
| Wernicke -> Broca | 0.1816 | 0.8066 | Superior_Longitudinal_Fasciculus |
| IFG -> Broca | 0.1792 | 0.8122 | Within_IFG_Fibres |
| Insula -> Broca | 0.1782 | 0.8098 | Short_Arcuate_Fibres |
| STG -> Broca | 0.1760 | 0.7984 | no prior edge |
| STG -> Insula | 0.1724 | 0.8053 | Extreme_Capsule_System |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.1997 |
| AD-associated propensity | 0.4247 |
| Stage-transition propensity | 0.2275 |
...
|---|---|---|---|---|---|
| 1 | IFG | 0.8872 | 1.0000 | 0.6240 | 1.0000 |
| 2 | Broca | 0.7262 | 0.7850 | 1.0000 | 0.3739 |
| 3 | Insula | 0.5097 | 0.3951 | 0.7828 | 0.3894 |
| 4 | STG | 0.1943 | 0.2657 | 0.2933 | 0.0000 |
| 5 | Wernicke | 0.0474 | 0.0000 | 0.0000 | 0.1579 |
...
|---|---|---|---|
| IFG | surface_to_volume_ratio | 0.0222 | increases |
| IFG | std_intensity | 0.0208 | increases |
| Broca | surface_to_volume_ratio | 0.0124 | increases |
| Insula | brain_volume_mm3 | 0.0122 | increases |
| IFG | surface_area_vox | 0.0101 | increases |
| Insula | surface_to_volume_ratio | 0.0094 | increases |
| Wernicke | mean_intensity | 0.0088 | increases |
| Broca | gm_volume_mm3 | 0.0047 | increases |
| Broca | surface_area_vox | 0.0037 | increases |
| IFG | brain_volume_mm3 | 0.0025 | increases |
