...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0011_MR1` |
| Generated | 2026-09-21 23:26:06 |
...
- Top-class probability: 0.6034
- Margin over runner-up: 0.3207
- Normalised predictive entropy: 0.8277 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Wernicke | 0.9431 | Speech comprehension, auditory word recognition |
| 2 | IFG | 0.7727 | Syntactic processing, verbal working memory |
| 3 | Broca | 0.6463 | Speech production, phonological encoding |
| 4 | Insula | 0.3256 | Articulatory planning, phonological awareness |
| 5 | STG | 0.3069 | Auditory-verbal processing, spectrotemporal analysis |
...
|---|---|---|---|
| Wernicke -> Broca | 0.1785 | 0.8124 | Superior_Longitudinal_Fasciculus |
| Insula -> Wernicke | 0.1772 | 0.8097 | Extreme_Capsule_System |
| Wernicke -> Insula | 0.1747 | 0.8065 | Extreme_Capsule_System |
| STG -> Insula | 0.1734 | 0.8016 | Extreme_Capsule_System |
| STG -> Broca | 0.1732 | 0.7969 | no prior edge |
...
| Wernicke -> IFG | 0.7136 |
| IFG -> Wernicke | 0.7088 |
| Wernicke -> Broca | 0.7075 |
| Broca -> Wernicke | 0.7035 |
| IFG -> Broca | 0.6999 |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.2543 |
| AD-associated propensity | 0.4490 |
| Stage-transition propensity | 0.2676 |
...
|---|---|---|---|---|---|
| 1 | Wernicke | 0.8402 | 1.0000 | 0.9180 | 0.5493 |
| 2 | IFG | 0.7914 | 0.7322 | 0.6617 | 1.0000 |
| 3 | Broca | 0.6646 | 0.5335 | 0.9789 | 0.5253 |
| 4 | Insula | 0.3118 | 0.0294 | 1.0000 | 0.0000 |
| 5 | STG | 0.1777 | 0.0000 | 0.0000 | 0.5924 |
...
|---|---|---|---|
| STG | surface_to_volume_ratio | 0.0407 | increases |
| Broca | surface_to_volume_ratio | 0.0296 | increases |
| IFG | std_intensity | 0.0265 | increases |
| IFG | surface_to_volume_ratio | 0.0261 | increases |
| Wernicke | surface_area_vox | 0.0224 | increases |
| Wernicke | kurtosis | 0.0163 | increases |
| Insula | surface_to_volume_ratio | 0.0112 | increases |
| Broca | brain_volume_mm3 | 0.0080 | increases |
| IFG | brain_volume_mm3 | 0.0067 | increases |
| Insula | skewness | 0.0025 | increases |
