...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0015_MR1` |
| Generated | 2026-09-21 23:26:08 |
...
- Top-class probability: 0.5682
- Margin over runner-up: 0.3300
- Normalised predictive entropy: 0.8928 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Wernicke | 0.7642 | Speech comprehension, auditory word recognition |
| 2 | STG | 0.5950 | Auditory-verbal processing, spectrotemporal analysis |
| 3 | Broca | 0.1882 | Speech production, phonological encoding |
| 4 | Insula | 0.1662 | Articulatory planning, phonological awareness |
| 5 | IFG | 0.1059 | Syntactic processing, verbal working memory |
...
|---|---|---|---|
| Insula -> STG | 0.1780 | 0.7942 | no prior edge |
| Wernicke -> IFG | 0.1773 | 0.7957 | no prior edge |
| Wernicke -> STG | 0.1747 | 0.8104 | Intra_STG_Fibres |
| STG -> IFG | 0.1736 | 0.7938 | no prior edge |
| Broca -> STG | 0.1731 | 0.7946 | no prior edge |
...
| STG -> Wernicke | 0.7048 |
| Wernicke -> STG | 0.6985 |
| Broca -> Wernicke | 0.6413 |
| Insula -> Wernicke | 0.6370 |
| Wernicke -> Broca | 0.6359 |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.4153 |
| AD-associated propensity | 0.5263 |
| Stage-transition propensity | 0.5989 |
...
|---|---|---|---|---|---|
| 1 | STG | 0.7003 | 0.7429 | 1.0000 | 0.3437 |
| 2 | Wernicke | 0.6749 | 1.0000 | 0.6986 | 0.2178 |
| 3 | Broca | 0.4088 | 0.1249 | 0.7738 | 0.4223 |
| 4 | Insula | 0.3366 | 0.0915 | 0.0000 | 1.0000 |
| 5 | IFG | 0.2808 | 0.0000 | 0.9362 | 0.0000 |
...
|---|---|---|---|
| Broca | normalized_volume | 0.0446 | increases |
| Insula | normalized_volume | 0.0434 | increases |
| STG | mean_intensity | 0.0356 | increases |
| IFG | normalized_volume | 0.0321 | increases |
| Insula | surface_area_vox | 0.0313 | increases |
| Wernicke | normalized_volume | 0.0275 | increases |
| Insula | kurtosis | 0.0233 | increases |
| STG | gm_fraction | 0.0191 | increases |
| Wernicke | mean_intensity | 0.0189 | increases |
| Broca | surface_area_vox | 0.0153 | increases |
