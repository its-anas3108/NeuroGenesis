...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0032_MR1` |
| Generated | 2026-09-21 23:26:24 |
...
- Top-class probability: 0.6734
- Margin over runner-up: 0.4792
- Normalised predictive entropy: 0.7757 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Wernicke | 0.5240 | Speech comprehension, auditory word recognition |
| 2 | Insula | 0.4766 | Articulatory planning, phonological awareness |
| 3 | STG | 0.3769 | Auditory-verbal processing, spectrotemporal analysis |
| 4 | IFG | 0.3239 | Syntactic processing, verbal working memory |
| 5 | Broca | 0.2280 | Speech production, phonological encoding |
...
|---|---|---|---|
| IFG -> Broca | 0.1922 | 0.8041 | Within_IFG_Fibres |
| Wernicke -> Broca | 0.1896 | 0.8040 | Superior_Longitudinal_Fasciculus |
| Insula -> Broca | 0.1819 | 0.8050 | Short_Arcuate_Fibres |
| STG -> Wernicke | 0.1764 | 0.8099 | Intra_STG_Fibres |
| STG -> Broca | 0.1758 | 0.7928 | no prior edge |

### Highest propagation-representation pathways (NeuroProp-X ANP)

| Pathway | Propagation score |
|---|---|
| Insula -> Wernicke | 0.6492 |
| STG -> Wernicke | 0.6472 |
| Wernicke -> STG | 0.6443 |
| Wernicke -> Insula | 0.6431 |
| STG -> Insula | 0.6288 |
...
|---|---|
| Reference stage | MCI |
| Advanced-stage alignment | 0.4864 |
| AD-associated propensity | 0.5052 |
| Stage-transition propensity | 0.3706 |
...
|---|---|---|---|---|---|
| 1 | Wernicke | 0.7077 | 1.0000 | 0.7124 | 0.3132 |
| 2 | STG | 0.6592 | 0.5032 | 0.5263 | 1.0000 |
| 3 | Broca | 0.5091 | 0.0000 | 1.0000 | 0.6969 |
| 4 | Insula | 0.4368 | 0.8398 | 0.0000 | 0.3364 |
| 5 | IFG | 0.1553 | 0.3240 | 0.0856 | 0.0000 |
...
|---|---|---|---|
| Broca | brain_volume_mm3 | 0.0544 | increases |
| Wernicke | normalized_volume | 0.0529 | increases |
| STG | mean_intensity | 0.0509 | increases |
| STG | surface_area_vox | 0.0445 | increases |
| STG | voxel_count | 0.0376 | increases |
| Broca | surface_area_vox | 0.0364 | increases |
| STG | entropy | 0.0359 | increases |
| Insula | cortical_thickness_mm | 0.0310 | increases |
| Broca | normalized_volume | 0.0270 | increases |
| Insula | surface_to_volume_ratio | 0.0259 | increases |
