...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0056_MR1` |
| Generated | 2026-09-21 23:26:37 |
...
Reference CDR-derived stage for this session: **AD**. The model's assignment agrees with it.

### Model confidence

- Top-class probability: 0.6775
- Margin over runner-up: 0.4935
- Normalised predictive entropy: 0.7729 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Broca | 0.6247 | Speech production, phonological encoding |
| 2 | STG | 0.4932 | Auditory-verbal processing, spectrotemporal analysis |
| 3 | Wernicke | 0.4868 | Speech comprehension, auditory word recognition |
| 4 | IFG | 0.4087 | Syntactic processing, verbal working memory |
| 5 | Insula | 0.4016 | Articulatory planning, phonological awareness |
...
|---|---|---|---|
| Wernicke -> Broca | 0.1786 | 0.8075 | Superior_Longitudinal_Fasciculus |
| IFG -> STG | 0.1784 | 0.8021 | Inferior_Fronto_Occipital_Fasciculus |
| STG -> Insula | 0.1777 | 0.8043 | Extreme_Capsule_System |
| Wernicke -> STG | 0.1769 | 0.8061 | Intra_STG_Fibres |
| Insula -> Broca | 0.1766 | 0.8080 | Short_Arcuate_Fibres |
...
| Broca -> IFG | 0.6583 |
| IFG -> Broca | 0.6581 |
| Wernicke -> Broca | 0.6539 |
| Broca -> Wernicke | 0.6492 |
| Insula -> Broca | 0.6471 |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.8849 |
| AD-associated propensity | 0.4691 |
...
|---|---|---|---|---|---|
| 1 | Broca | 0.9861 | 1.0000 | 0.9537 | 1.0000 |
| 2 | Insula | 0.4822 | 0.0000 | 0.9085 | 0.6990 |
| 3 | STG | 0.4642 | 0.4105 | 1.0000 | 0.0000 |
| 4 | Wernicke | 0.4241 | 0.3820 | 0.4195 | 0.4850 |
| 5 | IFG | 0.1747 | 0.0318 | 0.0000 | 0.5399 |
...
|---|---|---|---|
| Broca | surface_to_volume_ratio | 0.0566 | increases |
| Insula | normalized_volume | 0.0525 | increases |
| Wernicke | normalized_volume | 0.0420 | increases |
| IFG | normalized_volume | 0.0390 | increases |
| Insula | surface_area_vox | 0.0351 | increases |
| IFG | voxel_count | 0.0341 | increases |
| Broca | normalized_volume | 0.0306 | increases |
| Broca | brain_volume_mm3 | 0.0280 | increases |
| Wernicke | kurtosis | 0.0261 | increases |
| STG | normalized_volume | 0.0238 | increases |
