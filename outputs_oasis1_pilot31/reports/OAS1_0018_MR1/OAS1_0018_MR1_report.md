...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0018_MR1` |
| Generated | 2026-09-21 23:26:11 |
...
- Top-class probability: 0.5300
- Margin over runner-up: 0.2605
- Normalised predictive entropy: 0.9212 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | IFG | 0.6332 | Syntactic processing, verbal working memory |
| 2 | Insula | 0.6059 | Articulatory planning, phonological awareness |
| 3 | Broca | 0.4801 | Speech production, phonological encoding |
| 4 | Wernicke | 0.3583 | Speech comprehension, auditory word recognition |
| 5 | STG | 0.0734 | Auditory-verbal processing, spectrotemporal analysis |
...
|---|---|---|---|
| Wernicke -> Insula | 0.1813 | 0.8029 | Extreme_Capsule_System |
| IFG -> Insula | 0.1745 | 0.8071 | Inferior_Fronto_Occipital_Fasciculus |
| STG -> Wernicke | 0.1724 | 0.8041 | Intra_STG_Fibres |
| Broca -> Insula | 0.1716 | 0.8057 | Short_Arcuate_Fibres |
| STG -> Insula | 0.1690 | 0.8017 | Extreme_Capsule_System |
...
|---|---|
| Reference stage | CN |
| Advanced-stage alignment | 0.2440 |
| AD-associated propensity | 0.4430 |
| Stage-transition propensity | 0.3277 |
...
|---|---|---|---|---|---|
| 1 | Insula | 0.9059 | 0.9511 | 1.0000 | 0.7515 |
| 2 | IFG | 0.7000 | 1.0000 | 0.0000 | 1.0000 |
| 3 | Broca | 0.4744 | 0.7265 | 0.3647 | 0.2480 |
| 4 | Wernicke | 0.4147 | 0.5090 | 0.5528 | 0.1508 |
| 5 | STG | 0.1220 | 0.0000 | 0.4065 | 0.0000 |
...
|---|---|---|---|
| Insula | surface_area_vox | 0.0673 | increases |
| IFG | normalized_volume | -0.0422 | decreases |
| Broca | brain_volume_mm3 | 0.0237 | increases |
| IFG | brain_volume_mm3 | 0.0211 | increases |
| Wernicke | gm_volume_mm3 | 0.0188 | increases |
| IFG | cortical_thickness_mm | 0.0109 | increases |
| IFG | atrophy_index | 0.0103 | increases |
| STG | surface_to_volume_ratio | 0.0067 | increases |
| Broca | surface_to_volume_ratio | -0.0030 | decreases |
| IFG | surface_to_volume_ratio | 0.0029 | increases |
