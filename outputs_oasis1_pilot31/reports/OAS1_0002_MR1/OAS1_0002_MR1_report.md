...
| Field | Value |
|---|---|
| Subject ID | `OAS1_0002_MR1` |
| Generated | 2026-09-21 23:26:02 |
...
- Top-class probability: 0.4794
- Margin over runner-up: 0.0152
- Normalised predictive entropy: 0.7928 (0 = fully confident, 1 = uniform)
...
|---|---|---|---|
| 1 | Insula | 0.8167 | Articulatory planning, phonological awareness |
| 2 | IFG | 0.8054 | Syntactic processing, verbal working memory |
| 3 | Broca | 0.6661 | Speech production, phonological encoding |
| 4 | STG | 0.6275 | Auditory-verbal processing, spectrotemporal analysis |
| 5 | Wernicke | 0.3890 | Speech comprehension, auditory word recognition |
...
|---|---|---|---|
| Wernicke -> STG | 0.1777 | 0.8067 | Intra_STG_Fibres |
| Wernicke -> Broca | 0.1775 | 0.8076 | Superior_Longitudinal_Fasciculus |
| Insula -> Broca | 0.1748 | 0.8129 | Short_Arcuate_Fibres |
| IFG -> STG | 0.1745 | 0.8076 | Inferior_Fronto_Occipital_Fasciculus |
| IFG -> Broca | 0.1744 | 0.8135 | Within_IFG_Fibres |
...
|---|---|
| Reference stage | AD |
| Advanced-stage alignment | 0.4981 |
| AD-associated propensity | 0.4603 |
...
|---|---|---|---|---|---|
| 1 | IFG | 0.7781 | 0.9738 | 0.2954 | 1.0000 |
| 2 | Broca | 0.7146 | 0.6479 | 0.9812 | 0.5368 |
| 3 | Insula | 0.6436 | 1.0000 | 0.0000 | 0.8120 |
| 4 | STG | 0.5231 | 0.5577 | 1.0000 | 0.0000 |
| 5 | Wernicke | 0.2158 | 0.0000 | 0.4780 | 0.2412 |
...
|---|---|---|---|
| IFG | normalized_volume | 0.0471 | increases |
| Broca | normalized_volume | 0.0273 | increases |
| Insula | normalized_volume | 0.0210 | increases |
| Insula | brain_volume_mm3 | 0.0176 | increases |
| Wernicke | normalized_volume | 0.0127 | increases |
| STG | normalized_volume | 0.0117 | increases |
| Wernicke | kurtosis | 0.0094 | increases |
| Insula | surface_area_vox | 0.0079 | increases |
| IFG | kurtosis | 0.0075 | increases |
| Broca | kurtosis | 0.0075 | increases |
